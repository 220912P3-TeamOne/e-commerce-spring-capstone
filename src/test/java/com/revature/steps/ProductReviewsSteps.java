...
public class ProductReviewsSteps {
    ...
    public void the_user_hovers_over_a_product_card() {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div[3]/div[2]/div/div[1]/div[2]/div")));
        WebElement productCard  = driver.findElement(By.xpath("/html/body/div/div[3]/div[2]/div/div[1]/div[2]/div"));
    ...
    public void the_user_clicks_on_the_view_box() {
        ...
        WebElement viewBox = driver.findElement(By.xpath
                ("//*[@id=\"root\"]/div[3]/div[2]/div/div[1]/div[2]/div"));
        Actions hover = new Actions(driver);
